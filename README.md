...
- [How I Bypassed the Control Plane in Azure OpenAI](https://trustoncloud.com/blog/how-i-bypassed-the-control-plane-in-azure-openai/) - Case study on how Azure OpenAI can be abused to sidestep RBAC and audit controls. Demonstrates risks in managed service integrations and data plane bypass techniques.
...
- [An Attempt at Detecting Managed Identity Abuse](https://trustoncloud.com/blog/an-attempt-at-detecting-managed-identity-abuse/) - A deep dive into abuse patterns of Azure Managed Identities and the practical limitations of detection techniques. Highlights blind spots and proposes actionable monitoring strategies.
